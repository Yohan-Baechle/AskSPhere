...
class Question
{
    ...
    #[Assert\NotBlank(message: 'Please fill in the title')]
    #[Assert\Length(min: 10, minMessage: 'Please describe your question in detail', max: 255, maxMessage: 'The title of your question is too long')]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: 'Please fill in the title')]
    #[Assert\Length(min: 100, minMessage: 'Please describe your question in detail')]
